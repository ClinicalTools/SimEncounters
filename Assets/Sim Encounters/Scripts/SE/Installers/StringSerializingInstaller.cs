...
namespace ClinicalTools.SimEncounters
{
    public class StringSerializingInstaller : MonoInstaller
    {
        ...
        {
            subcontainer.Bind<IStringSplitter>()
                        .To<DoubleColonStringSplitter>()
                        .AsTransient();
            subcontainer.Bind<IStringDeserializer<List<EncounterMetadata>>>()
                        .To<ListDeserializer<EncounterMetadata>>()
                        .AsTransient();
            ...
            subcontainer.Bind<IStringDeserializer<EncounterImageContent>>()
                        ...
                        .AsTransient();
            subcontainer.Bind<IStringDeserializer<XmlDocument>>()
                        .To<XmlDocumentDeserializer>()
                        .AsTransient();
            ...
            subcontainer.Bind<ICharEnumeratorDeserializer<QuizStatus>>()
                        ...
                        .AsTransient();
            subcontainer.Bind<ICharEnumeratorDeserializer<string>>()
                        .To<KeyDeserializer>()
                        .AsTransient();

            subcontainer.Bind<IStringDeserializer<Color>>()
                        .To<ColorDeserializer>()
                        .AsTransient();

            subcontainer.Bind<IStringSerializer<Sprite>>()
                        .To<SpriteSerializer>()
                        .AsTransient();

            subcontainer.Bind<IStringSerializer<EncounterMetadata>>()
                        .To<EncounterMetadataSerializer>()
                        .AsTransient();
        }
