...
namespace ClinicalTools.SimEncounters.Writer
{
    public class EncounterUploader : IEncounterWriter
    {
        ...
        protected virtual WWWForm CreateForm(User user, Encounter encounter)
        {
            ...
            AddFormImageDataFields(form, encounter.Images);
        ...
        private void AddFormContentFields(WWWForm form, EncounterContent content)
        {
        ...
        private void AddFormImageDataFields(WWWForm form, EncounterImageData imageData)
        {
