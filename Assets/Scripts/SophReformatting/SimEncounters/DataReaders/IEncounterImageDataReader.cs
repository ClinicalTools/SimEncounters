...
namespace ClinicalTools.SimEncounters
{
    ...
    public class LegacyServerImageDataReader : IImageDataReader
    {
        private readonly IServerReader serverReader;
        private readonly IUrlBuilder urlBuilder;
        private readonly IParser<EncounterImageData> parser;
        public LegacyServerImageDataReader(IServerReader serverReader, IUrlBuilder urlBuilder, IParser<EncounterImageData> parser)
        {
        ...
        private void ProcessResults(WaitableResult<EncounterImageData> result, WaitedResult<string> serverResult)
        {
