...
{
    public abstract class ChildOrderablePanelsDrawer : MonoBehaviour
    {
        public abstract List<ReaderOrderableItemPanelUI> DrawChildPanels(IEnumerable<UserPanel> childPanels);
    }
