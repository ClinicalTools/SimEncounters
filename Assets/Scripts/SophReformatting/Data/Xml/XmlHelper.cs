...
namespace SimEncounters
{
    public class XmlHelper
    {
        ...
        public static XmlElement CreateElement(string name, XmlNode parent = null)
        {
        ...
        public static XmlElement CreateElement(string name, string value, XmlNode parent = null)
        {
