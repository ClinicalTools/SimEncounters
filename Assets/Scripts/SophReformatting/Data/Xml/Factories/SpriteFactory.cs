...
{
    public class SpriteFactory : ISerializationFactory<Sprite>
    {
        protected virtual NodeInfo WidthName { get; } = new NodeInfo("width");
        protected virtual NodeInfo HeightName { get; } = new NodeInfo("height");
        protected virtual NodeInfo DataName { get; } = new NodeInfo("data");
        ...
        public Sprite Deserialize(XmlDeserializer deserializer)
        {
            ...
            string imageData = GetImageData(deserializer);
