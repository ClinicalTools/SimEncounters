...
public class Test : MonoBehaviour
{
    ...
    bool TestCei()
    {
        ...
        xmlDoc.LoadXml(data2.Trim());
        var deserializer = new XmlDeserializer(xmlDoc);
        var encounterData = deserializer.GetValue(LegacyEncounterDataInfo, EncounterDataFactory);
        ...
        serializer2.AddValue(NewEncounterDataInfo, encounterData, EncounterDataFactory);

        UnityEngine.Debug.Log(stopwatch.ElapsedMilliseconds);

        var deserializer2 = new XmlDeserializer(xmlDoc2);
        var encounterData2 = deserializer2.GetValue(NewEncounterDataInfo, EncounterDataFactory);
        var xmlDoc3 = new XmlDocument();
        var serializer3 = new XmlSerializer(xmlDoc3);
        serializer3.AddValue(NewEncounterDataInfo, encounterData2, EncounterDataFactory);

        var equal = xmlDoc3.InnerXml == xmlDoc2.InnerXml;
        UnityEngine.Debug.LogWarning(equal);
    ...
    bool TestCed()
    {
        ...
        var xmlDoc = new XmlDocument();
        xmlDoc.LoadXml(imgData1.Trim());
        var deserializer = new XmlDeserializer(xmlDoc);
        var encounterData = deserializer.GetValue(LegacyEncounterDataInfo, ImageDataFactory);
        ...
        var xmlDoc2 = new XmlDocument();
        var serializer2 = new XmlSerializer(xmlDoc2);
        serializer2.AddValue(NewEncounterDataInfo, encounterData, ImageDataFactory);

        UnityEngine.Debug.Log(stopwatch.ElapsedMilliseconds);

        var deserializer2 = new XmlDeserializer(xmlDoc2);
        var encounterData2 = deserializer2.GetValue(NewEncounterDataInfo, ImageDataFactory);
        var xmlDoc3 = new XmlDocument();
        var serializer3 = new XmlSerializer(xmlDoc3);
        serializer3.AddValue(NewEncounterDataInfo, encounterData2, ImageDataFactory);
